...
Operated by: Find HH
Contact: portervenue@gmail.com

PLEASE READ THESE TERMS CAREFULLY BEFORE USING THE APP. BY CREATING AN ACCOUNT OR USING HH, YOU AGREE TO BE BOUND BY THESE TERMS. IF YOU DO NOT AGREE, DO NOT USE THE APP.
...
•	Any content you submitted may be removed or anonymized
...
•	Grant Find HH a worldwide, royalty-free, perpetual license to use, display, reproduce, and distribute your User Content within the App
•	Agree that your content may be edited, removed, or moderated at our discretion

Prohibited Content
You agree NOT to submit User Content that:
•	Is false, misleading, or inaccurate
•	Is defamatory, harassing, threatening, or abusive toward any person or business
•	Contains hate speech, discrimination, or content targeting protected characteristics
•	Infringes on any third party's intellectual property rights
•	Contains spam, advertisements, or unsolicited promotions
...
This Privacy Policy has been updated to reflect: (1) user-submitted content, (2) account deletion rights, and (3) Apple App Store compliance requirements including Guideline 5.1.1.
...
•	User-submitted content — happy hour listings, venue details, specials, hours, and other information you submit through the App

b. Information Collected Automatically
•	Device information (device type, operating system version, unique device identifiers)
•	App usage data (screens viewed, features used, session duration, crash reports)
•	Diagnostic data to improve app performance and stability
...
•	Display and moderate user-submitted happy hour content within the App
•	Provide, improve, and personalize App features
•	Send important service-related communications (account verification, policy updates)
...
•	Safety: When necessary to protect the rights, safety, or property of our users or the public
•	Business transfers: In the event of a merger, acquisition, or sale of assets, your information may be transferred as part of that transaction with prior notice to you
